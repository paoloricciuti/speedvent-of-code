...
<Tree
  classes="absolute transform bottom-[-6%] origin-bottom scale-75 text-green-700"
/>

<Tree
  classes="absolute transform bottom-[-10%] right-0 origin-bottom scale-75 text-green-700"
/>

<main class="w-screen h-screen overflow-auto p-4">
      ...
      >
        <span class="w-full">
          ...
          <sup tabindex="0" class="group relative"
            >[?]
            <Container
              classes="leading-[initial] absolute group-hover:block group-focus-visible:block hidden top-1/2 transform -translate-y-1/2 left-0"
            >
              {#if session}
